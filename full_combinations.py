    ...
    try:
        cur.execute("""
            SELECT 
                ...
                warehouse_category, code, category_table_id, mask, category_name
...
def Update_data():
    ...
    for row in Maskalar:
        (mask_id, warehouse_id, regions_id, region_name, category_id,
         warehouse_category, code, category_table_id, mask_name, category_name) = row
        ...
        if '{A}' in phonenumber:
                    ...
                    if A != B:
                        ...
                        cur.execute("""
                            INSERT INTO full_combinations (
                                mask_id, warehouse_id, regions_id, region_name, category_id, 
                                warehouse_category, code, category_table_id, mask, category_name, phonenumber
                            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                        """, (mask_id, warehouse_id, regions_id, region_name, category_id,
                              warehouse_category, code, category_table_id, mask_name, category_name, phonenumber1))
            ...
            """, (mask_id, warehouse_id, regions_id, region_name, category_id,
                  warehouse_category, code, category_table_id, mask_name, category_name, phonenumber))
