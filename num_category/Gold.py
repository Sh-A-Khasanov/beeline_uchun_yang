...
BACKOFF_BASE = 2.0
BACKOFF_JITTER = 1.0
BASE_URL = "https://nomer.beeline.uz/msapi/web/rms-new/phone-numbers?"
# BASE_URL = "https://nomer.beeline.uz/msapi/web/rms/phone-numbers/"
# https://nomer.beeline.uz/msapi/web/rms-new/phone-numbers?phone_number_mask=9989*******1&lang=uz&page=0&size=90&include_details=true
# https://nomer.beeline.uz/msapi/web/rms/phone-numbers/phone_number_mask=9989********&lang=uz&page=0&size=90&include_details=true (attempt=1)
USER_AGENTS = [
...
async def process_row(session, row):
    ...
    first_url = f"{BASE_URL}phone_number_mask={phone_number_mask}&lang=uz&page=0&size=90&include_details=true"
    print(first_url)
    log(first_url)
